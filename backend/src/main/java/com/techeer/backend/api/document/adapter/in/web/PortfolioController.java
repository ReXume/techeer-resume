...
public class PortfolioController {
    ...
    public ResponseEntity<ApiResponse<PortfolioInfoResponse>> getPortfolio(@PathVariable Long portfolioId) {
    ...
    public ResponseEntity<ApiResponse<Void>> deletePortfolio(@PathVariable Long portfolioId) {
        ...
        return ResponseEntity.ok(ApiResponse.success(SuccessCode.PORTFOLIO_DELETE_SUCCESS));
    }
