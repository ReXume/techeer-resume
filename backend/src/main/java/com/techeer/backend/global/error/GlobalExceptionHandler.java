...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(
		...
		final ErrorResponse response = ErrorResponse.of(ErrorCode.INPUT_VALUE_INVALID, e.getMessage(),
				e.getParameterName());
	...
	@ExceptionHandler
	protected ResponseEntity<ErrorResponse> handleMissingServletRequestPartException(MissingRequestCookieException e) {
		final ErrorResponse response = ErrorResponse.of(ErrorCode.INPUT_VALUE_INVALID, e.getMessage(),
				e.getCookieName());
		log.warn(e.getMessage());
		return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
